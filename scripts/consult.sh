...
PQA_API_KEY="${PQA_API_KEY:-${XIAOMI_API_KEY:-}}"
if [ -z "${PQA_API_KEY:-}" ] || [ "${PQA_API_KEY}" = "put-your-openai-compatible-api-key-here" ] || [ "${PQA_API_KEY}" = "put-your-xiaomi-token-plan-key-here" ]; then
